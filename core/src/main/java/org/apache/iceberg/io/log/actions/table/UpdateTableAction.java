...
public class UpdateTableAction implements LogAction {
  ...
  public UpdateTableAction(
      int tblId, int tblVersion, String location, TableIdentifier tableIdentifier) {
    this.tblId = tblId;
  ...
  public void apply(CatalogState.Builder builder) {
    builder.tableBuilder().updateTable(tblId, tblVersion + 1, location);
  }

  @Override
  public void serialize(DataOutputStream dos) throws IOException {
    dos.writeByte(Type.UPDATE_TABLE.ordinal());
    dos.writeInt(tblId);
  ...
  public static UpdateTableAction deserialize(DataInputStream dis) throws IOException {
    ...
    return new UpdateTableAction(tblId, tblVersion, location, null);
  }
