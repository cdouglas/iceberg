DROP
    VIEW IF EXISTS ${external_catalog}_${external_database}_ssv_${stream_num};

CREATE
    TEMP VIEW ${external_catalog}_${external_database}_ssv_${stream_num} AS SELECT
    ...
    JOIN ${external_catalog}_${external_database}_s_purchase_lineitem_${stream_num} ON
        (
...
INSERT
    INTO
        ${catalog}.${database}.store_sales SELECT
            ...
            ss_sold_date_sk
        FROM
            ${external_catalog}_${external_database}_ssv_${stream_num};
