DROP
    VIEW IF EXISTS ${external_catalog}_${external_database}_wsv_${stream_num};

CREATE
    TEMP VIEW ${external_catalog}_${external_database}_wsv_${stream_num} AS SELECT
    ...
    JOIN ${external_catalog}_${external_database}_s_web_order_lineitem_${stream_num} ON
        (
...
INSERT
    INTO
        ${catalog}.${database}.web_sales SELECT
            ...
            ws_sold_date_sk
        FROM
            ${external_catalog}_${external_database}_wsv_${stream_num};
