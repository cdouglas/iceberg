DROP
    VIEW IF EXISTS ${external_catalog}_${external_database}_csv_${stream_num};

CREATE
    TEMP VIEW ${external_catalog}_${external_database}_csv_${stream_num} AS SELECT
    ...
    JOIN ${external_catalog}_${external_database}_s_catalog_order_lineitem_${stream_num} ON
        (
...
INSERT
    INTO
        ${catalog}.${database}.catalog_sales SELECT
            ...
            cs_sold_date_sk
        FROM
            ${external_catalog}_${external_database}_csv_${stream_num};
