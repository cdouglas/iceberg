/* All varchar have been replaced with string to ensure matching schema between catalog and csv data source */
...
/* ALTER TABLE
    ${external_catalog}_${external_database}_catalog_sales RECOVER PARTITIONS; */

/* DROP
    TABLE
        IF EXISTS ${external_catalog}_${external_database}_catalog_returns; */
